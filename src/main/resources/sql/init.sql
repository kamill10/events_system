...
INSERT INTO public.event (id, version ,name, description, isNotCanceled, counter, startDate, endDate, created_at, action_type) VALUES ('dbe1b405-aed0-4d0a-bda7-50938e7b45f1', 0, 'Dni Języków Programowania', 'Idealne wydarzenie dla fanów programownia', true, 0, '2024-11-11 00:00:00', '2024-11-13 23:59:59', '2024-05-21', 'CREATE');
INSERT INTO public.event (id, version ,name, description, isNotCanceled, counter, startDate, endDate, created_at, action_type) VALUES ('fffc5e88-3054-4776-9189-4e64f1a33291', 0, 'Research Days', 'Dni w których zobaczysz jak wygląda praca naukowców', true, 0, '2024-09-20 00:00:00', '2024-09-25 23:59:59', '2024-06-21', 'CREATE');
INSERT INTO public.event (id, version ,name, description, isNotCanceled, counter, startDate, endDate, created_at, action_type) VALUES ('9470ac2b-d589-4740-b7b6-dd665690d531', 0, 'Dni Otwarte Politechniki', 'Zazwyczaj też są otwarte, ale teraz będą bardziej', true, 0, '2024-10-10 00:00:00', '2024-10-24 23:59:59', '2024-08-21', 'CREATE');
INSERT INTO public.event (id, version ,name, description, isNotCanceled, counter, startDate, endDate, created_at, action_type) VALUES ('5b9cd583-b097-40a6-887f-7d4f440f99c9', 0, 'Binożowy Tydzień', 'W końcu będziesz wiedział od czego to skrót', true, 0, '2024-02-11 00:00:00', '2024-02-13 23:59:59', '2024-01-21', 'CREATE');
INSERT INTO public.event (id, version ,name, description, isNotCanceled, counter, startDate, endDate, created_at, action_type) VALUES ('c89e341e-7927-40e7-a4d9-1695314b20e8', 0, 'Łódka Naukowców', 'Popłyń z nami w rejs wiedzy', true, 0, '2024-10-14 00:00:00', '2024-11-19 23:59:59', '2024-07-13', 'CREATE');
INSERT INTO public.event (id, version ,name, description, isNotCanceled, counter, startDate, endDate, created_at, action_type) VALUES ('c89e341e-7927-40e7-a4d9-1695314b20e9', 0, 'Wire week', 'Każdy ziom zbiera złom, sprzedaj pralkę, sprzedaj łom, popal kable, przetop druty, żeby mieć na nowe buty!', true, 0, '2024-06-05 00:00:00', '2024-06-06 23:59:59', '2024-05-13', 'CREATE');
