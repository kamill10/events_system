...
test('test', async ({ page }) => {
  ...
  await page.locator('div').filter({ hasText: /^Current password\*$/ }).getByLabel('toggle password visibility').press('Tab');
  ...
  await expect(page.getByText("Email with confirmation has been sent!")).toBeVisible();
});